...
;(async () => {
  ...
  // 点击一个节点后再点另一个：验证高亮移动
  await page.mouse.click(532, 655)   // 蔡秀美（估计）
  await page.waitForTimeout(400)
  await page.screenshot({ path: path.join(__dirname, 'clip-1.png'), clip: { x: 400, y: 610, width: 200, height: 90 } })
  await page.mouse.click(339, 484)   // 张圣祥（估计）
  await page.waitForTimeout(400)
  await page.screenshot({ path: path.join(__dirname, 'clip-2.png'), clip: { x: 240, y: 440, width: 260, height: 90 } })
  await browser.close()
